...
- Платформа создания и управления Логосами
- Маркетплейс миссий (задач)
- Экономическая система (Qi Energy + AGC)
...
- Фазы выпуска:
  - Элитные (3 символа): 46,656 комбинаций — для основателей, VIP
  - Премиум (4 символа): 1,679,616 комбинаций — ранние пользователи
  - Стандартные (5+ символов): массовый выпуск
